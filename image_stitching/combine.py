...
def compute_matches(features0, features1, matcher, knn=5, lowe=0.7):
    """
    this applies lowe-ratio feature matching between feature0 and feature1 using flann
    """
...
def combine_images(img0, img1, h_matrix):
    ...
    points0 = reshape(img0)
    points1 = reshape(img1)

    points1 = cv2.perspectiveTransform(points1, h_matrix)
    points = numpy.concatenate((points0, points1), axis=0)
